...
public class Module4TestNGTest {
    ...
    public void shouldOpenChrome() throws MalformedURLException {
        ...
        String sauceUserName = System.getenv("Partizan");
        String sauceAccessKey = System.getenv("bf0700ed-1cd4-450e-be66-b80b1fe8eb1d");
        String sauceURL = "https://ondemand.eu-central-1.saucelabs.com:443";
