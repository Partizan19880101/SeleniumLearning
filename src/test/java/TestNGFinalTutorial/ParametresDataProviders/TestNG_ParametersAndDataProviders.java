package TestNGFinalTutorial.ParametresDataProviders;
...
public class TestNG_ParametersAndDataProviders {
	...
	public static Object[][] searchData() {
		return new Object[][] {{"New York", "Chicago", "10/28/2019", "10/31/2019"},
				{"New York", "Boston", "12/28/2019", "12/31/2019"}};
	}
	...
	public void searchFlights(String origin, String dest,
		...
		SearchPage.clearReturning(driver);
