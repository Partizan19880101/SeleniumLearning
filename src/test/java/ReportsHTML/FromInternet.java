...
public class FromInternet {
    ...
    public void verifyHomePageTitle() {
        report = new ExtentReports(
                "D:\\Новая папка\\ChromeIeGecko\\reports\\automationreport2.html", true);
    ...
    public void verifyLogo() throws IOException {
        ...
        if (src.equals("")) {
            ...
            String image= test.addScreenCapture("C:\\Users\\Admin\\Desktop\\Automation\\ChromeIeGecko\\Report\\\\img.jpg");
